...
$(document).ready(function ($) {
    ...
    // typed.js
    $(".typed a").typed({
        strings:["撸过此.....","路过此站的人","留下点什么吧","ohyhello"],
        typeSpeed: 20,
        backSpeed: 20,
        backDelay: 600
    });
    ...
    document.addEventListener('visibilitychange', function () {
        if (document.hidden) {
            $('[rel="shortcut icon"]').attr('href', "https://www.ohyhello.com/file/1.ico");
            document.title = '藏好了！qaq';
            clearTimeout(titleTime);
        }
        else {
            $('[rel="shortcut icon"]').attr('href', "https://www.ohyhello.com/file/1.ico");
            document.title = '被找到了(*/ω＼*)' + OriginTitile;
   ...
   /* $("#pagination a").on("click", function () {
    ...
    function show_date_time() {
        ...
        var BirthDay = new Date("9/1/2017 00:00:00");
        var today = new Date();
