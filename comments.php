...
<div class="block comment-block">
    ...
    $args = array(
        ...
        'label_submit' => '咻～',
        'comment_notes_after' => '',
        'comment_field' => '<div class="content-field"> <textarea class="text-block" id="comment-content" name="comment" cols="45" rows="8" aria-required="true" placeholder="|´・ω・)ノ还不快点说点什么呀poi~"></textarea>
		<!--owo表情-->
		<div class="OwO"></div>
	</div>',
    );
